...
delimiter $$
CREATE PROCEDURE SP_EditarToDo(
...
begin	
				...
				UPDATE  TblTo_Do SET tarea = _Tarea WHERE id = _Id;
...
delimiter $$
CREATE PROCEDURE SP_EditarDoing(
...
begin	
				...
				UPDATE  TblDoing SET tarea = _Tarea WHERE id = _Id;
...
delimiter $$
CREATE PROCEDURE SP_EditarDone(
...
begin	
				...
				UPDATE  TblDone SET tarea = _Tarea WHERE id = _Id;
