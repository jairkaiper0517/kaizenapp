...
class Application
{
    ...
    public function __construct()
    {
        ...
        if (!$this->url_controller) {
            ...
            require APP . 'controller/principal.php';
            $page = new Principal();
            $page->index();
    ...
    public function isRequiredLogin()
    {
        ...
        $controllers = array("/", "login/", "login/index", "login/iniciarSesion", "error404/index", "error404/");
        ...
        if (in_array($access, $login)) {
            ...
            if (isset( $_SESSION["login"]))
            {
                header("location: ".URL."principal/propositos");
            }
        }
    }
}
